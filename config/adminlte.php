...
return [
    ...
    */
    ...
    'logo_mini' => 'L',
    // 'logo' => '<img src=" '.URL::to("/logo.png").'" />',

    // 'logo_mini' => '<img src=" '.URL::to("/logo.png").'" />',
    ...
    */
    ...
    'menu' => [
        ...
        [   'text'        => 'Меню',
            'url'         => 'admin/posts?group=menu',
            'icon'        => 'fas fa-align-justify'
        ],
        [   'text'        => 'НАШИ УСЛУГИ',
            'url'         => 'admin/posts?group=services',
            'icon'        => 'fas fa-american-sign-language-interpreting'
        ],
        [   'text'        => 'Наши партнеры',
            'url'         => 'admin/posts?group=partners',
            'icon'        => 'fa fa-anchor'
        ],
        ['text'        => 'Товары(Категория)',
            'url'         => 'admin/posts?group=tags',
            'icon'        => 'fas fa-tags'
        ],
        [
            'text'        => 'Товары',
            'url'         => 'admin/posts?group=products',
            'icon'        => 'fas fa-box-open'
        ],
        [
            'text'        => 'Новости',
            'url'         => 'admin/posts?group=news',
            'icon'        => 'fas fa-bolt'
        ],
        [
            'text'        => 'Галлерея',
            'url'         => 'admin/posts?group=gallery',
            'icon'        => 'fas fa-photo-video'
        ],
        [   'text'        => 'Слайдер главный',
            'url'         => 'admin/posts?group=sliderMain',
            'icon'        => 'fas fa-suitcase-rolling'
        ],
        // [
        //     'text'        => 'Премьеры',
        //     'url'         => 'admin/posts?group=premiere',
        //     'icon'        => 'fas fa-film'
        // ],
        // [
        //     'text'        => 'Путешествия',
        //     'url'         => 'admin/posts?group=trips',
        //     'icon'        => 'fas fa-suitcase-rolling'
        // ],
        // [
        //     'text'        => 'Программы главный',
        //     'url'         => 'admin/posts?group=pros',
        //     'icon'        => 'fas fa-tv'
        // ],
        // [
        //     'text'        => 'Программы телепередач',
        //     'url'         => 'admin/programs?status=active',
        //     'icon'        => 'fas fa-tv',
        //     'label_color' => 'success',
        // ],
        // [
        ...
        [
            'text'        => 'Настройки',
            'url'         => 'admin/posts?group=settings',
            'icon'        => 'fas fa-cog'
        ],
        // [
        //     'text'        => 'Дачи',
        //     'url'         => 'posts?group=dachas',
        //     'icon'        => 'fas fa-igloo'
        // ],
