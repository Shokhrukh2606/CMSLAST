...
<div id="listWithHandle" class="list-group">
    ...
    <div class="list-group-item">
         <a href=" {{URL::to('/admin/posts/edit/'.$_GET['group'].'/'.$item->id)}}" class="btn btn-info pull-right">Редактировать</a>
       
        <span class="glyphicon glyphicon-move" aria-hidden="true"></span>
        {{getLangSpec($item->title, 'ru')}}
...
<td>{{getLangSpec($item->short_content, 'ru')}}</td>
